...
//   // Compute selected crypto equivalent dynamically
//   const selectedConversion = (
//     bot.price / CRYPTO_MODES.find((c) => c.symbol === selectedMode)!.rate
//   ).toFixed(6);
...
//     if (!proofs) {
//       Alert.alert("Error", "Bot price or proofs is missing");
//       return;
//     }
...
//       formData.append("amount", bot.price.toString());
//       formData.append("mode", selectedMode);

//       // Append proofs image
//       formData.append("images", {
//         uri: proofs,
//         name: proofs.split("/").pop() || "proofs.jpg",
//         type: "image/jpeg",
//       } as any);
...
//         text2:
//           response.message || `You have successfully purchased ${bot.name}`,
//         position: "top",
//       });
...
//                   {proofs ? "Change Proof" : "Upload Proof"}
//                 </Text>
//               </TouchableOpacity>

//               {/* Preview of selected proofs */}
//               {proofs && (
//                 <View
//                   style={{
//                     marginBottom: 12,
